...
def make_exe():
    ...
    python_config.run_command = "from dridge.cli import main; main()"

    # Run a Python module as __main__ when the interpreter starts.
    # python_config.run_module = "dridge.cli"
    ...
    # to our binary.
    exe.add_python_resources(exe.pip_install(["-r", "requirements.txt", "--no-deps"]))
